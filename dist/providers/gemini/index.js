...
exports.Gemini = exports.GeminiProvider = exports.GEMINI_DEFAULT_MODEL = void 0;
const core_1 = require("../../core");
exports.GEMINI_DEFAULT_MODEL = 'gemini-1.5-pro';
class GeminiProvider extends core_1.BaseProvider {
    constructor() {
        super(...arguments);
        this.name = 'gemini';
        this.request = {
    ...
    buildRequest(canonical) {
        ...
        const contents = canonical.messages
        ...
        return {
            model: canonical.model || exports.GEMINI_DEFAULT_MODEL,
            config: {
    ...
    // HELPERS
    // ----------------------------------------------------------------------
    toGeminiParts(content, mode = 'normal', extraContext) {
    ...
    toGeminiFunction(tool) {
        return {
            name: tool.name,
            description: tool.description,
            parameters: tool.parameters // Assuming JSON Schema compatibility
        };
    }
}
exports.GeminiProvider = GeminiProvider;
exports.Gemini = new GeminiProvider();
